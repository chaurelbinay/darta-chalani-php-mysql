...
if(a==0 || b==0 || c==0 || d==0 || e==0 || f==0)
 ...
 <table border="1">
 	<form name="cinsert1" method="POST" enctype="multipart/form-data" action="chalaniinsert.php" onsubmit="return check1();" >
     <tr><td>चलानी नं</td><td>:</td><td><input type="text" name="cid" id="cid"><a href="chalani.php">back</a></td></tr>
  <tr><td>चलानी मिती</td><td>:</td><td><input type="text" name="cdate" id="cdate"  value="<?php echo $nda; ?>"></td></tr>
  ...
  <tr><td>कैफियत</td><td>:</td><td><input type="text" name="extra" id="extra"></td></tr>
 	...
 	<tr><td align="center" colspan="3"><input type="submit" name="sub1" value="submit"></td></tr>
...
<br />
    ...
    <table border=1 width="100%" name="abcd" id="abcd">
    	<tr style="color: white; background-color: green "><td colspan="2" align="center"><br/> चलानी</td><td colspan="2" align="center"><br/>चलानी हुने पत्रकाे</td><td rowspan="2" align="center">बिषय</td><td rowspan="2" align="center" ><br/>पत्र चलान गर्ने अफिसकाे नाम</td><td rowspan="2" align="center" ><br/>टिकट</td><td rowspan="2" align="center"><br/> कैफियत</td><td rowspan="2" align="center"><br/>फाइल</td></tr>
...
$src="chalani/".$file;
   ?>
<tr><td align="center"><?php echo $cid   ?></td><td align="center"><?php echo $cdate   ?></td><td align="center"><?php echo $papercount   ?></td><td align="center"><?php echo $paperdate   ?></td><td align="center"><?php echo $subject   ?></td><td align="center"><?php echo $sendoffice   ?></td><td></td><td align="center"><?php echo $extra   ?></td><td align="center"><a href=<?php echo $src ?>><?php echo "file"  ?></a></td></tr>
   <?php
