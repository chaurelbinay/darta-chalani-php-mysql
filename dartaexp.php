...
function check()
{
  var h=document.getElementById("dnum").value;
...
if(a==0 || b==0 || c==0 || d==0 || e==0|| f==0 || h==0)
 ...
 <table border="1">
    ...
    <tr><td>दर्ता नं</td><td>:</td><td><input type="text" name="dnum" id="dnum"><a href="darta.php">back</a></td></tr>
    	<tr><td>दर्ता मिती</td><td>:</td><td><input type="text" name="ddate" id="ddate"  value="<?php echo $nda; ?>"></td></tr>
  ...
  <tr><td>बुझेकाे मिती</td><td>:</td><td><input type="text" name="recdate" id="recdate"  value="<?php echo $nda; ?>"></td></tr>
 	...
 	<tr><td align="center" colspan="3"><input type="submit" name="subexp" value="submit"></td></tr>
...
<br />
    ...
    <table border=1 width="100%" name="abcd" id="abcd">
    	<tr style="color: white; background-color: green "><td rowspan="2" align="center"><br/> दर्ता नं</td><td rowspan="2" align="center"><br/>दर्ता मिती</td><td colspan="2" align="center">प्राप्त भएकाे</td><td rowspan="2" align="center" ><br/>पठाउने अफिसकाे नाम</td><td rowspan="2" align="center" ><br/>विषय</td><td colspan="3" align="center">बुझिलिने फाटवाला</td><td rowspan="2" align="center"><br/> कैफियत</td><td rowspan="2" align="center"><br/>फाइल</td></tr>
...
//code for search end
 ...
 while($row = mysqli_fetch_assoc($result1))
 {
  ...
  $extra=$row["extra"];
   ...
   $src="darta/".$file;
   ?>
<tr><td align="center"><?php echo $did   ?></td><td align="center"><?php echo $date   ?></td><td align="center"><?php echo $lettercount   ?></td><td align="center"><?php echo $letterdate   ?></td><td align="center"><?php echo $senderoffice   ?></td><td align="center"><?php echo $subject   ?></td><td align="center"><?php echo $recname   ?></td><td align="center"><?php echo $recsign   ?></td><td align="center"><?php echo $recdate   ?></td><td align="center"><?php echo $extra   ?></td><td align="center"><a href=<?php echo $src ?>><?php echo "file"  ?></a></td></tr>
   <?php
